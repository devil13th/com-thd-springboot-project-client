    ...
    return (
      <div>
          ...
          <dl className="form_col">
            ...
            <Input value={this.state.indexInfo.path} onChange={(e) => {this.createInputMode(e.target.value, "path")}}/>
            </dd>
          </dl>
          <dl className="form_col">
            <dt>Classify : </dt>
          ...
          <dl className="form_col">
            ...
            <dd style={{ display: 'flex' }}>
            <Input value={this.state.indexInfo.suffix} onChange={(e) => {this.createInputMode(e.target.value, "suffix")}}/>
            </dd>
          </dl>
          ...
          <dl className="form_col">
            ...
            onChange={(checked) => {this.createInputMode(checked, "reIndex")}} 
          ...
          <Space>
          <Button type="primary" onClick={this.reIndexFolderByClassify}>Index Folder</Button>
